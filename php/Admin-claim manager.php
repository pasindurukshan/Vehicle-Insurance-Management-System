...
<div id="mySidebar" class="sidebar">
  ...
  <a onclick="document.getElementById('id01').style.display='block'">Add new </a>
  <a href="Admin-claim manager-delete.php">Delete </a>
  <a href="Admin-claim manager-update.php">Update</a>
  <a href="#">Log out</a> 
 </br>
 <div class="dropdown">
...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" method="post" action="../php/Submit claim.php" enctype="multipart/form-data">
    <div class="container">
	...
	<h3>Vehicle Type:</h3> </br>
		...
		<label for="bus">Comprehensive Insurance </label> </br></br>
		 ...
		 <label><h3>Upload Pictorial Evidence:</h3><label></br>
		 <div class="file-border">
		 <input class="file-submission" type="file" name="filename1"/> </br> </br>
		 </div>
		 
		 <label><h3>Upload Video Evidence:</h3><label></br>
		 <div class="file-border">
		 <input class="file-submission" type="file" name="filename2"/> </br> </br>
  	<center>
		 <input class="sub-btn" type="submit"  id="submit_button"/>
