...
<!--This is a hyperlink is for get social media icons which mention in w3school; Reference: https://www.w3schools.com/howto/howto_css_social_media_buttons.asp -->
	...
	<link rel="stylesheet" type ="text/css" href="../css/insurance-stylesheet.css">
	 <link rel="stylesheet" type ="text/css" href="../css/cmng.css">
...
<div style="bodybg">	
	...
	<div class="contact-section">
	 <center>
	<div class="div2">Display the customer inquiries.</div>
	</center>
	 <input type="submit" class="contact-form-btn" value="Delete inquiries">
  ...
  <form class="contact-form" action="index.html" method="post">
    <input type="text" class="contact-form-text" placeholder="customer name">
    <input type="email" class="contact-form-text" placeholder="customer email">
	 <textarea class="contact-form-text" placeholder="reply for customer"></textarea>
	 <input type="submit" class="contact-form-btn" value="Sumbit"> <br><br><br><br>
