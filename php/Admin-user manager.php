...
<div class="head">
	...
	<h2 style="text-align: center; font-family: verdana;">User Manager</h1>
...
<div id="mySidebar" class="sidebar">
  ...
  <a href="../html/Register_Page.html">Add new </a>
...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" method="post" action="../php/Submit user.php" enctype="multipart/form-data">
    <div class="container">
