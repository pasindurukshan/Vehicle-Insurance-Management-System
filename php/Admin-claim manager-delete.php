...
<div id="mySidebar" class="sidebar">
  ...
  <a onload="document.getElementById('id01').style.display='block'">Delete </a>
...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" method="post" action="delete-claim.php">
    <div class="container">
	...
	<input class="sub-btn" type="submit" name="submit"  id="submit_button" value="delete" />
